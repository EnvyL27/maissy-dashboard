  ...
  @Component({
    selector: 'app-energy-usage-yearly',
    templateUrl: './energy-usage-yearly.component.html',
    styleUrls: ['./energy-usage-yearly.component.css']
  })
  export class EnergyUsageYearlyComponent implements OnInit {
