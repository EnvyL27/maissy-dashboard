  ...
  @Component({
    selector: 'app-energy-monthly-report',
    templateUrl: './energy-monthly-report.component.html',
    styleUrls: ['./energy-monthly-report.component.css']
  })
  export class EnergyMonthlyReportComponent implements OnInit {
