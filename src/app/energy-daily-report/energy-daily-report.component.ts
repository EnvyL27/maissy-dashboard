  ...
  @Component({
    selector: 'app-energy-daily-report',
    templateUrl: './energy-daily-report.component.html',
    styleUrls: ['./energy-daily-report.component.css']
  })
  export class EnergyDailyReportComponent implements OnInit {
